...

{
    ...
    "title": "Tutorial",
    "category": "section",
    "text": "This tutorial will walk you through the features and functionality of AstroTime.jl. Everything in AstroTime.jl revolves around the Epoch data type. Epochs are basically a high-precision, time scale-aware version of the DateTime type from Julia\'s standard library. This means that while DateTime timestamps are always assumed to be based on Universal Time (UT), Epochs can be created in several pre-defined time scales or custom user-defined time scales."
},
